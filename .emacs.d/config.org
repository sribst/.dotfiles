...
*** OCaml
 ...
 (use-package ocp-indent :hook tuareg-mode)
 (use-package dune :hook tuareg-mode)
...
"* RESERVE %^{Name} [[http://maps.google.com/maps?q=\\2][@dress]] %^g
  :PROPERTIES:
  :Created:     %U
  :Name:   %\\1
  :Type:   %^{Type}p
  :Place:  %^{Place}
  :With:   %^{With}
  :GMap:   [[http://maps.google.com/maps?q=\\2][@dress]]
  :END:
  %^{When}T
")
