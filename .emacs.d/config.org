...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  :requires smart-mode-line-powerline-theme
  :custom (sml/theme 'powerline-theme)
  :config (sml/setup))
...
")
  ...
  (org-capture-templates
   `(("e" "Event")
      ("es" "Show")
        ("esr" "To book" entry (file+headline "~/org/master.org" "Show"),
          my/org-tobook-template)
        ("esg" "To go" entry (file+headline "~/org/master.org" "Show"),
          my/org-togo-template)
      ("er" "To book" entry (file+headline "~/org/master.org" "Agenda"),
        my/org-tobook-template)
