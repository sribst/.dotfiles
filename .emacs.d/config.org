...
#+RESULTS:
| (lambda (frame) (select-frame frame) (if (window-system frame) (unless my/theme-window-loaded (if my/theme-terminal-loaded (enable-theme my/theme) (progn (load-theme my/theme t) (set-face-background 'hl-line (x-get-resource color8 )))) (setq my/theme-window-loaded t)) (unless my/theme-terminal-loaded (if my/theme-window-loaded (enable-theme my/theme) (progn (load-theme my/theme t) (set-face-background 'hl-line (x-get-resource color8 )))) (setq my/theme-terminal-loaded t)))) | (lambda (frame) (auto-package-update-maybe)) | x-dnd-init-frame |
...
#+RESULTS:
| rust-mode | racer-mode | cargo-minor-mode |
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;; (file+headline "~/org/master.org" "Projects")))
#+end_src
