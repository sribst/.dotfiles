...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 7eb57a6a9da61bf5905d840d59e6c2ce ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/sribaroud/.opam/ocaml-base-compiler.4.14.1/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/sribaroud/.opam/ocaml-base-compiler.4.14.1/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/sribaroud/.opam/ocaml-base-compiler.4.14.1/bin/ocp-indent"))
