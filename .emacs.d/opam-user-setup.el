...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 8bd3f50a062007ec98e75680a6a9d68a ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/sribaroud/CS/Project/tezos/_opam/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/sribaroud/CS/Project/tezos/_opam/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/sribaroud/CS/Project/tezos/_opam/bin/ocp-indent"))
;; ## end of OPAM user-setup addition for emacs / ocp-indent ## keep this line
;; ## added by OPAM user-setup for emacs / tuareg ## c024934aaf49cb4b44d32299a299a6f0 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/sribaroud/CS/Project/tezos/_opam/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
